...
function nextstep_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'nextstep' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'nextstep_custom_background_args', array(
...
function nextstep_scripts() {
	wp_enqueue_style( 'nextstep-style', get_stylesheet_uri() );

	wp_enqueue_script( 'nextstep-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'nextstep-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
